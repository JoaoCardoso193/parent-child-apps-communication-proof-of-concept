...
function set_now(fn) {
  module.runSetters(now = fn);
}

function set_raf(fn) {
  module.runSetters(raf = fn);
}
...
function init_hydrate(target) {
  ...
  if (target.nodeName === 'HEAD') {
    ...
    module.runSetters(children = myChildren);
  }
  /*
...
function set_current_component(component) {
  module.runSetters(current_component = component);
}
...
if (typeof HTMLElement === 'function') {
  module.runSetters(SvelteElement = class extends HTMLElement {
    constructor() {
      super();
      this.attachShadow({
        mode: 'open'
...
}},"store":{"index.mjs":function module(require,exports,module){
...
let noop, safe_not_equal, subscribe, run_all, is_function;
module.link("../internal/index.mjs", {
  noop(v) {
    noop = v;
  },
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                     //
// node_modules/svelte/store/package.json                                                                              //
//                                                                                                                     //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
module.exports = {
...
}},"index.mjs":function module(require,exports,module){
